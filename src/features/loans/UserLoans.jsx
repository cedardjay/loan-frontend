...
const style = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── TOP NAV (from BorrowerDashboard) ── */
  .topnav {
  ...
  /* ── SIDEBAR (from BorrowerDashboard) ── */
  .sidebar {
  ...
  /* ── BOTTOM NAV (from BorrowerDashboard) ── */
  .bottom-nav {
    display: none;
...
// Sidebar nav items — same as BorrowerDashboard, with myLoans as active
const navItems = [
  ...
  return (
    <>
      ...
      <div className="app-wrap">
        ...
        {/* ── TOP NAV (matches BorrowerDashboard) ── */}
        ...
        <div className="layout">
          ...
          {/* ── SIDEBAR (matches BorrowerDashboard, myLoans active) ── */}
          <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
            ...
            <nav className="sidebar-nav">
              {navItems.map(item => (
                <div
                  key={item.id}
                  className={`nav-item ${item.id === "myLoans" ? "active" : ""}`}
        ...
        {/* ── BOTTOM NAV (matches BorrowerDashboard) ── */}
